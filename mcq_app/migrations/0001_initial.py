# Generated by Django 3.1 on 2020-08-30 23:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maximum_marks', models.DecimalField(decimal_places=2, default=5, max_digits=6, verbose_name='Maximum Marks')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='choices', to='mcq_app.question')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attempts', to='mcq_app.quizprofile')),
                ('selected_choice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mcq_app.choice')),
            ],
            options={
                'abstract': False,
            },
